package com.eldpepar.security.filter;

import com.alibaba.fastjson.JSON;
import com.eldpepar.common.result.ResponseUtil;
import com.eldpepar.common.result.Result;
import com.eldpepar.common.result.ResultCodeEnum;
import com.eldpepar.common.util.helper.IpUtil;
...
public class TokenLoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void unsuccessfulAuthentication(HttpServletRequest request, HttpServletResponse response, AuthenticationException e) throws IOException, ServletException {
        if (e.getCause() instanceof RuntimeException) {
            ResponseUtil.out(response, Result.build(null, ResultCodeEnum.PASSWORD_ERROR.getCode(), e.getMessage()));
        } else {
